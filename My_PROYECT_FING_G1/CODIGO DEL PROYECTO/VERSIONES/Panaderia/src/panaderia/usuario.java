...
public class usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Fondo_negro.png"))); // NOI18N
        ...
        H_asistencias.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 430, 190));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
            try{
                ...
                String sqlAsistencia = "INSERT INTO asistencias (usuario, fecha, hora,hora_salida) VALUES (?, ?, ?,?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String sql = "SELECT fecha, hora, hora_salida FROM asistencias WHERE usuario = "+usuario+"";
            PreparedStatement ps = cn.prepareStatement(sql);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String sqlAsistencia = "UPDATE asistencias SET hora_salida=? WHERE usuario="+usuario+" AND fecha=?";
        PreparedStatement psAsistencia = cn.prepareStatement(sqlAsistencia);
